...
public class ConnexionChrome 
{
    ...
    ConnexionChrome(PrintWriter outToClient, String[] lecturaCliente, DataOutputStream salida) throws IOException {
    ...
    /*
        Aqui construyo el formulario de cabecera para chrome
    */
    public void formularioRespuesta()
    {
    ...
    public void enviarDocumentoHtml(String campos) throws FileNotFoundException, IOException
    {
        try{
            int i=0;
            File archivo = new File("RespuestasWebChrome"+campos);
