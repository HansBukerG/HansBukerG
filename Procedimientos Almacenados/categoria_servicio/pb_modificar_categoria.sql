/**INICIO_DATOS_PROCEDIMIENTO	
	...
	@-Descripcion_Objeto0: Modifica una categoría en el sistema
	@-Regla_Objeto0: Debe existir una categoria previa en el sistema para poderla modificar
	@-String_Prueba0: EXEC Documentos_ubb.dbo.pb_modificar_categoria;
	
FIN_DATOS_PROCEDIMIENTO**/	


alter proc dbo.pb_modificar_categoria
(  
	@CATE_CODIGO          integer,
	@OFRE_CODIGO          integer,
	@CCO_CODIGO           decimal,
...
BEGIN TRANSACTION;
	...
	UPDATE DOCUMENTOS_UBB.dbo.CATEGORIA_SERVICIO with(updlock)
	SET CATE_NOMBRE		 	= @CATE_NOMBRE
	,	CATE_ABREVIACION	= @CATE_ABREVIACION
	,   CATE_FECHA_TERMINO	= @CATE_FECHA_TERMINO
	,	CATE_FECHA_INICIO	= @CATE_FECHA_INICIO
	,   CATE_FECHA_REGISTRO	= @CATE_FECHA_REGISTRO
	,   CATE_LOG_REGISTRO	= @CATE_LOG_REGISTRO
