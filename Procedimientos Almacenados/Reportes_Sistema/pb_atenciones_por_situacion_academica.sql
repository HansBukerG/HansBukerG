...
/**INICIO_DATOS_PROCEDIMIENTO	
	...
	@-Parametro_Salida2: saa_descripcion
	@-Parametro_Salida3: count(*) as hora_fecha_registro

	@-Descripcion_Objeto0: SP de reporte con atenciones por situacion academica del Sistema de Gestión de Filas
	@-Regla_Objeto0: Debe existir una oficina de reparticion con actividad para poder generar reporte
	@-String_Prueba0: EXEC Documentos_ubb.dbo.pb_atenciones_por_situacion_académica;
	
FIN_DATOS_PROCEDIMIENTO**/	


alter proc dbo.pb_atenciones_por_situacion_académica
(
	 	@ofre_codigo		integer
	, 	@cco_codigo			decimal
	, 	@rep_codigo			decimal
...
group by cate_nombre,serv_nombre,saa_descripcion
order by 4 desc
