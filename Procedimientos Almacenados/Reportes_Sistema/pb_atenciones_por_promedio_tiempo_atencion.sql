/**INICIO_DATOS_PROCEDIMIENTO	
	...
	@-Parametro_Salida2: CONVERT(VARCHAR(10),cast(AVG(cast(fin_atencion-inicio_atencion as float)) as datetime),108) as duracion_atencion

	@-Descripcion_Objeto0: SP de reporte para promedios de atencion del Sistema de Gestión de Filas
	@-Regla_Objeto0: Debe existir una oficina de reparticion con actividad para poder generar reporte
	@-String_Prueba0: EXEC Documentos_ubb.dbo.pb_atenciones_por_promedio_tiempo_atencion  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ;
	
	
FIN_DATOS_PROCEDIMIENTO**/	


alter proc dbo.pb_atenciones_por_promedio_tiempo_atencion
(
	 	@ofre_codigo		integer
	, 	@cco_codigo			decimal
	, 	@rep_codigo			decimal
