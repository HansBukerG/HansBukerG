/**INICIO_DATOS_PROCEDIMIENTO	
	...
	@-Parametro_Salida0: nombre_funcionario
	@-Parametro_Salida1: count(*) as hora_fecha_registro

	@-Descripcion_Objeto0: SP de reporte por funcionario del Sistema de Gestión de Filas
	@-Regla_Objeto0: Debe existir una oficina de reparticion con actividad para poder generar reporte
	@-String_Prueba0: EXEC Documentos_ubb.dbo.pb_atenciones_por_funcionario;
	
FIN_DATOS_PROCEDIMIENTO**/	


alter proc dbo.pb_atenciones_por_funcionario
(
	 	@ofre_codigo		integer
	, 	@cco_codigo			decimal
	, 	@rep_codigo			decimal
