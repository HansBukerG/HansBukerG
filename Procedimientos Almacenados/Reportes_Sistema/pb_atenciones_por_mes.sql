...
/**INICIO_DATOS_PROCEDIMIENTO	
	...
	@-Parametro_Salida2: cate_nombre
	@-Parametro_Salida3: serv_nombre
	@-Parametro_Salida4: count(*) as hora_fecha_registro

	@-Descripcion_Objeto0: SP de reporte mensual del Sistema de Gestión de Filas
	@-Regla_Objeto0: Debe existir una oficina de reparticion con actividad para poder generar reporte
	@-String_Prueba0: EXEC Documentos_ubb.dbo.pb_atenciones_por_mes;s
	
FIN_DATOS_PROCEDIMIENTO**/	


alter proc dbo.pb_atenciones_por_mes
(
	 	@ofre_codigo		integer
	, 	@cco_codigo			decimal
	, 	@rep_codigo			decimal
...
group by datename(year,fecha_registro),datename(month,fecha_registro),cate_nombre,serv_nombre
order by 1,2 desc
