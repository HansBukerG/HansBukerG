/**INICIO_DATOS_PROCEDIMIENTO	
	...
	@-Parametro_Salida0: datename(year,fecha_registro) as year
	@-Parametro_Salida1: datename(month,fecha_registro) as mes
	@-Parametro_Salida2: datename(day,fecha_registro) as dia
	@-Parametro_Salida3: cate_nombre
	@-Parametro_Salida4: serv_nombre
	@-Parametro_Salida5: count(*) as hora_fecha_registro

	@-Descripcion_Objeto0: SP de reporte diario del Sistema de Gestión de Filas
	@-Regla_Objeto0: Debe existir una oficina de reparticion con actividad para poder generar reporte
	@-String_Prueba0: EXEC Documentos_ubb.dbo.pb_atenciones_por_dia;
	
FIN_DATOS_PROCEDIMIENTO**/	


alter proc dbo.pb_atenciones_por_dia
(
	 	@ofre_codigo		integer
	, 	@cco_codigo			decimal
	, 	@rep_codigo			decimal
...
SELECT
	datename(year,fecha_registro)	as year
,	datename(month,fecha_registro)	as mes
,	datename(day,fecha_registro)	as dia
,	cate_nombre
,	serv_nombre	
,   count(*) as hora_fecha_registro
...
group by datename(year,fecha_registro),datename(month,fecha_registro),datename(day,fecha_registro),cate_nombre,serv_nombre
order by 1,2 desc
