/**INICIO_DATOS_PROCEDIMIENTO	
	...
	@-Parametro_Salida0: t3.mae_rut 
	@-Parametro_Salida1: t3.rep_codigo 
	@-Parametro_Salida2: t6.EDU_CODIGO 
	@-Parametro_Salida3: t1.ofre_codigo 
	@-Parametro_Salida4: t4.mae_nombre 
	@-Parametro_Salida5: t4.mae_apellido_paterno 
	@-Parametro_Salida6: t4.mae_apellido_materno 
	@-Parametro_Salida7: t5.rep_nombre 
	@-Parametro_Salida8: t6.EDU_DESCRIPCION 

	@-Descripcion_Objeto0: SP encargado de buscar y entregar una lista con los usuarios con contrato vigente en una oficina
	@-Regla_Objeto0: Debe existir una oficina para poder buscar funcionarios, en caso de no tener funcionarios, el sp retornara tuplas vacias
	@-String_Prueba0: EXEC Documentos_ubb.dbo.pb_buscar_usuarios_oficina;
